...
Any reader accepts an ordered list of keys instead of a single name. The first key with a defined value wins, which turns aliases and renames into a one-liner.
