...
The fallback supplies the default and removes `undefined` from the type. See [Envapter](/docs/functional-api) for the full reader API and [Converters](/docs/converters) for non-primitive types.
